...
export function PatientCard({id,name, contact, date, vaccines, nextVaccine, nextVaccineDate, address, healthCentre}){
    ...
    return(
            ...
            <div className={styles.card}>
                 {vaccines.map((dosageVaccine) => {
                            ...
                            {console.log('novos dados recebidos:', vaccinesList
                            )}
